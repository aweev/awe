...
const getStatIcon = (stat: ImpactStat, index: number) => {
  ...
  if (
    stat.label.toLowerCase().includes("individual") ||
    stat.label.toLowerCase().includes("people")
  ) {
    return <Users className={iconClass} />;
  }
  if (
    stat.label.toLowerCase().includes("business") ||
  ...
  if (
    ...
    stat.label.toLowerCase().includes("success")
  ) {
...
const StatCard: React.FC<{
  ...
  return (
    <motion.div variants={dignifiedReveal} className="relative group">
        ...
        >
          ...
          >
            ...
            <p className="text-body-large text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Our data-driven approach ensures measurable, lasting impact in the
              communities we serve. Every number represents real lives
          ...
          {/* Bottom CTA Section */}
          <motion.div variants={dignifiedReveal} className="text-center pt-12">
            <div className="bg-card/60 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-border/40 shadow-lg theme-transition max-w-4xl mx-auto">
              <div className="space-y-6">
                ...
                <p className="text-body-base text-muted-foreground leading-relaxed">
                  Behind each statistic is a person whose life has been
                  transformed through our holistic approach. Join us in creating
                  more success stories and building stronger communities
                  together.
                </p>
