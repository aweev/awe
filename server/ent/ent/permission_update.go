...
func (_u *PermissionUpdate) AddRoles(v ...*RolePermission) *PermissionUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *PermissionUpdate) RemoveRoles(v ...*RolePermission) *PermissionUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddRoles adds the "roles" edges to the RolePermission entity.
func (_u *PermissionUpdateOne) AddRoles(v ...*RolePermission) *PermissionUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// RemoveRoles removes "roles" edges to RolePermission entities.
func (_u *PermissionUpdateOne) RemoveRoles(v ...*RolePermission) *PermissionUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
