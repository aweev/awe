...
func (_q *PermissionQuery) QueryRoles() *RolePermissionQuery {
...
func (_q *PermissionQuery) WithRoles(opts ...func(*RolePermissionQuery)) *PermissionQuery {
	query := (&RolePermissionClient{config: _q.config}).Query()
...
func (_q *PermissionQuery) loadRoles(ctx context.Context, query *RolePermissionQuery, nodes []*Permission, init func(*Permission), assign func(*Permission, *RolePermission)) error {
